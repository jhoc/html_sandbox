...
if (diagramSelector != null && diagramOptionsSelector != null) {
    ...
    function onChordChange( _chord: IntervallArray | null ): void {
    ...
    function onScaleChange( _scale: IntervallArray | null ): void {
        dia.setScale(_scale);
        if (diagramOptionsSelector != null) {
            diagramOptionsSelector.setDiagram(dia);
        }
    ...
    /////////////////////////77
    function onChordFingerChange( _fing: ChordFingering | null ): void {
...
function onChordFingereringFretChange(_s: number): void {
    // console.log( "onChordFingStringChange", _s );
...
diagramOptionsSelector.setCallbackOnChordFingeringFretChange(onChordFingereringFretChange);
    ...
    function onScaleFingerChange( _fing: ScaleFingering | null ): void {
